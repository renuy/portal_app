...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'slc', :domain => 'slc.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'ppn', :domain => 'ppn.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'krk', :domain => 'krk.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'knd', :domain => 'knd.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'bji', :domain => 'bji.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'ktd', :domain => 'ktd.justbooksclc.com'
  provider :google_apps, OpenID::Store::Filesystem.new('/tmp'), :name => 'kan', :domain => 'kan.justbooksclc.com'
